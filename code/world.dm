...
/world/New()
	...
	send_discord_message("public", "A new round is about to begin! Join with this address byond://fulpstation.com:3333 ! The current round number is **[yog_round_number]** and the chosen map is **[map_name]** ")
